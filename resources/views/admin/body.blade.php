        ...
        <section class="no-padding-bottom">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="{{asset('admincss/img/avatar-1.jpg')}}" alt="..." class="img-fluid">
                    ...
                    <h3 class="h5">Sumitra Poudel</h3><span>@sumitrapoudel</span></a>
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="{{asset('admincss/img/avatar-4.jpg')}}" alt="..." class="img-fluid">
                    ...
                    <h3 class="h5">Sunita Poudel</h3><span>@sunitapoudel</span></a>
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="{{asset('admincss/img/avatar-11.jpg')}}" alt="..." class="img-fluid">
                    <div class="order dashbg-4">3rd</div>
                  </div><a href="#" class="user-title">
                    <h3 class="h5">Saraswati Poudel</h3><span>@saraswatipoudel</span></a>
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="{{asset('admincss/img/avatar-10.jpg')}}" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Krishna Poudel</strong><span class="d-block">@krishnapoudel</span></a>
                </div>
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="{{asset('admincss/img/avatar-12.jpg')}}" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Aadarsh Karki</strong><span class="d-block">@aadarshkarki</span></a>
                </div>
                <div class="col-lg-4 text-center">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="{{asset('admincss/img/avatar-13.jpg')}}" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Shruti Ghimire</strong><span class="d-block">@shrutighimire</span></a>
                </div>
                <div class="col-lg-4 text-center">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  <div class="order">6th</div>
                  <div class="avatar"> <img src="{{asset('admincss/img/avatar-14.jpg')}}" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Shreyansh Ghimire</strong><span class="d-block">@shrutighimire</span></a>
                </div>
                <div class="col-lg-4 text-center">
                  <div class="contributions">140 Contributions</div>
                </div>
                <div class="col-lg-4">
                  <div class="details d-flex">
                    <div class="item"><i class="icon-info"></i><strong>50</strong></div>
                    <div class="item"><i class="fa fa-gg"></i><strong>40</strong></div>
                    <div class="item"><i class="icon-flow-branch"></i><strong>30</strong></div>
                  </div>
                </div>
              </div>
            </div>
